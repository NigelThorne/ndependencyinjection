...
namespace NDependencyInjection
{
    public class DecoratingServiceProvider<I> : IServiceProvider
    {
        ...
        private object FetchDecoratorInstance ( Type serviceType, Type interfaceType, IServiceLocator context,
            object decorated )
        {
        ...
        private object CreateDecoratorInstance ( Type serviceType, Type interfaceType, IServiceLocator context,
            object decorated )
        {
